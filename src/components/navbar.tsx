      ...
      <div className="container mx-auto px-4 sm:px-6 flex flex-col lg:flex-row justify-between items-center">
        <div className="flex items-center justify-between w-full lg:w-auto">
          ...
          >
            ...
            <span className="hidden sm:inline flex items-center gap-2">
              <span className="font-mono">PEDRO×ART</span>
            </span>
            <span className="sm:hidden font-mono">PEDRO ART</span>
          </Link>
        ...
        >
          ...
          <ul className="flex flex-col gap-4 mx-auto lg:gap-6 xl:gap-5 text-neutral-950 items-center mt-20 lg:mt-0 lg:flex-row">
            {[
              { href: "/art", label: "ARTSHUB" },
              { href: "/meme", label: "MEMEHUB" },
              { href: "/pedro", label: "PEDRONFT" },
              { href: "/pic", label: "PICLAND" },
              { href: "/nft", label: "NFTZONE" },
              { href: "https://pedroinjraccoon.online/", label: "PEDROHQ" },
            ].map((item) => (
              <li
                key={item.href}
