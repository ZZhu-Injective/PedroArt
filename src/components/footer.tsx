...
const quickLinks = [
  ...
  { href: "https://memedepot.com/d/pedro", label: "Meme" },
];

const Footer = () => {
  return (
    <footer className="w-full h-auto border-t border-white/10 relative z-30 bg-black/40 backdrop-blur-sm text-gray-300 font-mono">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm">
          ...
          <div className="flex gap-6 justify-center">
            <Link
              ...
              aria-label="Pedro on X (Twitter)"
              className="hover:opacity-70 transition-opacity"
            >
              <svg className="h-6 w-6" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Join Pedro on Discord"
              className="hover:opacity-70 transition-opacity"
            >
              <svg className="h-6 w-6" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Read the Pedro docs on GitBook"
              className="hover:opacity-70 transition-opacity"
            >
              <svg className="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <Link
              ...
              className="hover:opacity-70 transition-opacity"
            >
              <svg className="h-5 w-5 sm:h-6 sm:w-6" viewBox="0 0 24 24" aria-hidden="true">
